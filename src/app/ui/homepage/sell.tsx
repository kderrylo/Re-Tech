...
export const Sell = () => {
  return (
    <>
      <div className="grid grid-rows-4 md:grid-cols-2 md:grid-rows-2 gap-0 min-h-screen">
        <div className="order-1 relative flex items-center justify-center text-center bg-[url('/bg-contact.png')] bg-cover bg-center">
          <h3 className="relative z-10 text-neutral-white font-bold text-4xl md:text-5xl">
            Sell
          </h3>
        </div>
        <div className="order-2 flex flex-col items-center justify-center gap-6 text-dark p-8">
        ...
        <div className="order-4 md:order-3 flex flex-col items-center justify-center gap-6 text-dark p-8">
          <p className="text-center">
        ...
        <div className="order-3 md:order-4 relative flex items-center justify-center text-center bg-[url('/bg-shop.png')] bg-cover bg-center">
          <h3 className="relative z-10 text-neutral-white font-bold text-4xl md:text-5xl">
            Shop
          </h3>
        </div>
